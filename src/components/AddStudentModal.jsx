...
const validateForm = () => {
  ...
  <div className="bg-red-500/10 border border-red-500 text-red-400 text-sm px-3 py-2 rounded-lg flex items-center gap-2 animate-shake">
    ...
    {error}
          ...
          {errors.full_name && (
  <p className="text-red-400 text-xs mb-1">{errors.full_name}</p>
)}
          {/* Full Name */}
          <div>
...
{errors.email && (
  <p className="text-red-400 text-xs mb-1">{errors.email}</p>
)}
          {/* Email with OTP */}
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">
...
{errors.otp && (
  <p className="text-red-400 text-xs mb-2">{errors.otp}</p>
)}
          {/* OTP Section */}
          {otpSent && !otpVerified && (
          ...
          {errors.phone_number && (
  <p className="text-red-400 text-xs mb-1">{errors.phone_number}</p>
)}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">
              ...
              <span className="text-xs text-gray-500 ml-2">(minimum 10 digits)</span>
            </label>
            <div className="relative">
...
{errors.password && (
  <p className="text-red-400 text-xs mb-1">{errors.password}</p>
)}
